...
cd /home/devlin/ServerStuff/Nowhere-1.2-server/forge/ &&
sudo xterm -hold -e java -Xmx10G -Xms10G -jar /home/devlin/ServerStuff/Nowhere-1.2-server/forge/forge-1.12.2-14.23.5.2808-universal.jar nogui
